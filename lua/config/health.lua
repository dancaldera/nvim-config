...
local function check_config_consistency(report)
	...
	require_contains("docs/ARCHITECTURE.md", architecture_doc, "nvim-tree.lua", "nvim-tree architecture note")
	require_contains("docs/ARCHITECTURE.md", architecture_doc, "picker.lua", "picker plugin group")
	forbid_contains("docs/ARCHITECTURE.md", architecture_doc, "neo-tree.nvim", "removed neo-tree plugin")
	...
	forbid_contains("docs/PLUGINS_REFERENCE.md", plugins_doc, "nvim-neo-tree/neo-tree.nvim", "removed neo-tree plugin")
